...
**NOTA 3:** Podemos usar `pwd` para saber nuestra ubicación exacta.
:::

![](img/meme5.png){fig-align="center"}
...
9.  `cd ..`
    ...
    3.  No: El directorio **home** de Amanda es `/Users/ecoss`.

    4.  No: sube dos niveles, es decir termina en `/Users`.

    5.  Sí: `~` significa el directorio **home** del usuario, en este caso `/Users/ecoss`.
...
::: callout-note
Si colocamos `..` significa 'el directorio por encima del actual o el directorio anterior', pero si colocamos `.` significa el directorio actual.
:::
